...
export const generateImageCoreToolDefinition = {
	...
	description: "Generate an image using Stability AI's Core API service based on a provided prompt. This model and endpoint is a sensible default to use when not prompted to use a specific one, offering a good balance of cost and quality",
	inputSchema: {
		type: "object",
		properties: {
			prompt: {
